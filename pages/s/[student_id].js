...
export default function Student_id() {
  ...
  return (
    <main>
      ...
      <div className="mx-8 mb-6 flex gap-4 items-center mt-12">
        <h2>Documentos</h2> 
      ...
      {studentFiles.length > 0 ? (
        ...
        <div>
          <div className='w-full flex-col justify-center'>
            <p className='text-center font-light text-lg'>Aún no tienes ningún documento para {student?.username}. <br/> Sube docs. para que {student?.username} los pueda ver.</p>
      ...
      {classes.length > 0 ? (
        ...
        <div>
          <div className='w-full flex-col justify-center'>
            <p className='text-center font-light text-lg'>No tienes ninguna clase programada con {student?.username}. <br/>Añade alumnos para que reserven clases contigo.</p>
            <div className='pt-6 flex justify-center'>
              <AddStudentButton />
            </div>
          </div>
