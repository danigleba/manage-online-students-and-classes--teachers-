...
export default function CancellClassButton(props) {
  ...
  return (
    <main>
        <button onClick={() => setDeleteID(props?.item?.id)} className='hover:bg-[#dddddd] duration-200 bg-[#f7f7f7] border border-[#dddddd] font-medium py-1.5 px-4 items-center gap-1.5 rounded-md w-max text-[#222222] text-sm flex justify-center'>
            <TiDelete strokeWidth="0" color="#222222" size={20} />
            <p>Cancelar clase</p>
        </button>
        {/*Confirmation modal*/}
