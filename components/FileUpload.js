...
export default function FileUpload(props) {
  ...
  return (
    <main>
      <button onClick={() => setIsOpen(true)} className="hover:bg-[#000000] duration-200 flex items-center gap-2 bg-[#252422] rounded-md text-sm py-2 px-4 text-white font-semibold">
          ...
          <div className="modal-content py-6 text-left px-6">
            <div className="flex gap-4">
              <div>
                ...
                <input onChange={handleFileChange} className="w-full border border-[#f4f4f4] rounded-md text-sm cursor-pointer file:font-semibold file:cursor-pointer file:border-0 file:bg-[#f4f4f4] file:hover:bg-gray-200 file:mr-4 file:py-3 file:px-4" type="file"/>
              </div>
            </div>
            <div className="mt-6 w-full flex gap-4 modal-body">
