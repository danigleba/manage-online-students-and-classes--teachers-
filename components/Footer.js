...
export default function Footer() {
    return (  
        ...
        /*
        <footer className="mt-20 text-[#222222] bg-[#f7f7f7] mb-20 md:mb-0">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <hr className="my-6 lg:my-8 border-[#dddddd] sm:mx-auto"/>
                <span className="block text-sm sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">Cornelio</a>. Todos los derechos reservados.</span>
            </div>
        </footer>*/
    )
}